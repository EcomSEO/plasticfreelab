...
export const posts: Post[] = [
  {
    ...
    products: [
      ...
      },
      {
        ...
        tier: "Skip",
        summary:
          "Aesthetically beautiful, widely sold, and marketed as non-toxic — but the ceramic coating is the weakness. Independent reviewers and long-term owners consistently report coating degradation within 12 to 24 months of normal use. When the coating fails, you're cooking on whatever aluminum alloy is underneath. Caraway is PFOA-free, but a coating that doesn't last isn't a long-term non-toxic solution.",
      },
      {
        rank: 10,
        name: "HexClad Hybrid",
    ...
    faq: [
      ...
      },
      {
        ...
        a: "Not in the long-term sense. Every non-stick coating currently on the market — PTFE, ceramic sol-gel, ceramic-titanium hybrids — degrades. The question is only how fast. If you want release without a coating, a well-seasoned cast iron or carbon steel pan gets you 90% of the way there with nothing to chip. That's the honest answer.",
      },
      {
  ...
  },
  {
    ...
    faq: [
      ...
      },
      {
        ...
        a: "For PFAS and fluoride specifically, yes. RO is the only consumer-grade technology that reliably removes both. Carbon filters don't touch fluoride and have mixed PFAS performance. RO does strip minerals along with contaminants — that's a real tradeoff — but the idea that demineralized water is harmful in meaningful amounts isn't supported by current evidence. If you want the minerals back, remineralization cartridges or a pinch of sea salt in a gallon jug solves it.",
      },
      {
  ...
  },
  {
    ...
    faq: [
      ...
      },
      {
        ...
        a: "Commercial blood tests for PFAS and phthalate metabolites exist but are expensive and hard to interpret. Quest Diagnostics and LabCorp offer them with a physician order; direct-to-consumer panels from companies like Million Marker exist for phthalates. The results are informative but rarely actionable — knowing your phthalate number is high doesn't change the intervention, which is still: reduce exposure. For most people, skipping the test and making the swaps is the better use of resources.",
      },
    ],
    sources: [
      {
